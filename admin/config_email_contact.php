...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="481" valign="top" class="bg_center">
      <?
		...
		if ( (isset($_POST["form_config"])) && ($_POST["form_config"] == "form_config"))
		 {
			...
			email_contact_title='$email_title',email_contact='$email',email_contact_on_off='$on_off' ";
        ...
        <?
		 ...
		 $on_off=$rs["email_contact_on_off"];
		?>
    ...
    <thead>
      <tr>
        <th height="23" colspan="2" valign="middle" id="senderheader">Auto email contact </th>
	  </tr>
      </thead>
    <tr bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';>
      ...
      <td width="85%" height="22" valign=middle><input name="email_title" type="text" class="text" style="width:500px;" value="<?=$rs["email_contact_title"]?>" maxlength="100" /></td>
    </tr>
    <tr bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';>
      ...
      <td height="22" valign=middle><?php
						...
						$oFCKeditor->Value		= $rs["email_contact"];
						$oFCKeditor->Create() ;
						?></td>
    </tr>
    <tr bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';>
