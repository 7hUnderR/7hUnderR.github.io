...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="b2">
        <!--DWLayoutTable-->
              <tr>
                <td width="617" height="25" valign="bottom" class="bg_title">
				<? 
				$cat=$HTTP_GET_VARS["cat"];
				$id=$HTTP_GET_VARS["id"];
				$start=$HTTP_GET_VARS["start"];
				?>
				<a href="../index.php?cat=0&alpha=All&start=0"><img src="../images/home.gif" width="14" height="14" border="0"> Home</a> > Order > Detail</td>
             </tr>
              <tr>
			...
			//-->
                ...
                <tr align="left" > 
				  ...
				  <?
					...
					$tax=gia_tri_mot_cot('tb_shopping_cart_tax','tax_code',$tax_code,'tax_name');
					$tax_num=gia_tri_mot_cot('tb_shopping_cart_tax','tax_code',$tax_code,'tax_value');
				...
				if (isset($_SERVER['QUERY_STRING'])) 
                  ...
                  <td valign="middle" class="line_bottom"><table width="100%">
					  ...
					  <tr>
					    <td width="34" height="20" align="left" valign="middle" class="text"><span class="text" style="font-weight: bold">No</span></td>
				      <td width="285" valign="middle" class="text"><span style="font-weight: bold">Name</span></td>
				        <td width="44" valign="middle" class="text"><span style="font-weight: bold">Size</span></td>
				        <td width="43" valign="middle" class="text"><span style="font-weight: bold">Corlor</span></td>
				        <td width="78" valign="middle" class="text"><span style="font-weight: bold">Made</span></td>
				        <td width="40" valign="middle" class="text"><span style="font-weight: bold"><span style="font-weight: bold">Price</span></span></td>
				        <td width="39" valign="middle" class="text"><span style="font-weight: bold">Qty</span></td>
				        <td width="52" valign="middle" class="text"><span style="font-weight: bold">Sum</span></td>
				      </tr>
					  <?
					    $i=0;
						...
						$product_price=gia_tri_mot_cot('tb_product','id',$product_id,'product_price');
					  ?>
					  <tr valign="middle">
					    <td height="20" align="left" valign="middle" class="text"><?=$i?></td>
					    <td class="text"><?=$product_name?></td>
					    <td class="text"><?=$rs_product["product_size"]?></td>
					    <td class="text"><?=$rs_product["product_color"]?></td>
					    <td class="text"><?=$rs_product["product_made"]?></td>
					    <td class="text"><?=$product_price?></td>
					    <td class="text"><?=$product_qty?></td>
					    <td class="text"><?=$product_qty*$product_price?></td>
					  </tr>
					<? } ?>	
						<tr valign="middle">
					    <td height="20" colspan="6" align="right" valign="middle" class="text">Total:</td>
					    <td colspan="2" align="left" valign="middle" class="text"><?=$rs["sum_price"];?></td>
					  </tr>
				...
				<INPUT name="noi_dung" type=hidden id="noi_dung">
