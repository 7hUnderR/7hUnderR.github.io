...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
              <tr>
                <td height="25" valign="middle" class="bg_title"><a href="../index.php?cat=0&alpha=All&start=0"><img src="../images/home.gif" width="14" height="14" border="0"> Home</a> &gt; <?=$menu_industry_01?></td>
             </tr>
              <tr>
		...
		$table="tb_shopping_cart_industry order by thu_tu ASC ";
		...
		if ( (isset($_POST["form_color"])) && ($_POST["form_color"] == "form_color"))
		 {
			...
			$industry_code=max_id("tb_shopping_cart_industry","industry_code")+1;
			
			$table_="tb_shopping_cart_industry";
		...
		if ( (isset($_POST["messageList"])) && ($_POST["messageList"] == "messageList"))
		 {
			...
			$query__ = "DELETE  FROM tb_shopping_cart_industry WHERE id in (".$id.")";
		...
		if ( (isset($_POST["form_color_edit"])) && ($_POST["form_color_edit"] == "form_color_edit"))
		   {
			...
			$id=$_POST["id"];
			$industry_name=rep($_POST["industry_name"]);
				$query_edit = "UPDATE tb_shopping_cart_industry SET industry_name='$industry_name'";
		...
		<table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
			...
			<th width=50% id="senderheader"><?=$menu_industry_01?> name  </th>
			<th id="subjectheader" width=20%>Sort</th>
			<th id="subjectheader" width=15%><?=$menu_industry_01?> code </th>
			...
			<td><a href="industry_01.php?id=<?=$rs["id"]?>&do=edit"><img src="../images/edit.gif" width="12" height="12" border="0" /></a></td>
			</tr>
			<? } ?>
			</tbody>
		</table>
				...
				<input type="button" name="Submit32" value="Up date" onClick="update_industry('activate.php','?ma_activate=update_industry&key=sort')" class="nut_nhan">
				<input type="submit" name="Submit" value="Delete" onclick="return hoi('industry_01.php');"  class="nut_nhan">
              ...
              <tr>
				...
				if(strstr($qr,"edit"))
				  {
					$id=$HTTP_GET_VARS["id"];
					$query_edit = "Select * FROM tb_shopping_cart_industry WHERE id=$id ";
					$result_edit = mysql_query($query_edit);
               ...
               <form action="<?=$form_action?>" method="post" name="form_color_edit" onsubmit="return check_descount_edit(this);">
                  <tr>
                    ...
                    <td align="left" valign="middle" class="bg_2" style="font-weight: bold">Update <?=$menu_industry_01?></td>
                  </tr>
                  <tr>
                    <td width="30%" align="right" valign="middle" class="bg_2"><?=$menu_industry_01?>  Name: </td>
               ...
               <form action="<?=$form_action?>" method="post" name="form_color" onsubmit="return check_descount(this);">
                  <tr>
                    <td height="20" align="right" valign="middle" class="bg_2"><!--DWLayoutEmptyCell-->&nbsp;</td>
                    <td align="left" valign="middle" class="bg_2" style="font-weight: bold">New <?=$menu_industry_01?></td>
                  </tr>
                  <tr>
                    <td width="30%" align="right" valign="middle" class="bg_2"><?=$menu_industry_01?> Name: </td>
