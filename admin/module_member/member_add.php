...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
	...
	<tr class="bg_mo">
	  ...
	  <td valign="middle" class="text2" ><input name="ma_vung" type="text" class="bottom" id="ma_vung" style="WIDTH:100px;"></td>
	</tr>
	<tr class="bg_mo">
	  <td height="25" align="right" valign="middle" class="text_def" >Daytime Phone :</td>
	  <td valign="middle" class="text2" ><input name="dt_codinh" type="text" class="bottom" id="dt_codinh" style="WIDTH:150px;"></td>
	</tr>
	<tr class="bg_mo">
	...
	<tr class="bg_mo">
	  ...
	  <td valign="middle" class="text2" ><input name="Submit" type="submit" class="bottom" value="Add new">
