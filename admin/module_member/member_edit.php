...
if ((isset($_POST["update_profile_form"])) && ($_POST["update_profile_form"] == "update_profile_form"))
 {
	...
	if($pass!="")
	    ...
	    $pass=gia_tri_mot_cot("tb_member","ma_user",$ma_user,"pass");
		
	$ten=rep($HTTP_POST_VARS["fullname"]);
	$diem=rep($HTTP_POST_VARS["diem"]);
	...
	{
		$table = "tb_member";
		$query = "UPDATE $table SET email='$email',pass='$pass',ten='$ten',diem='$diem',sex='$sex',ngay_sinh='$ngay_sinh',address='$address',zip='$zip',city='$quan_huyen',country='$tinh_thanh',ma_vung='$ma_vung',dt_codinh='$dt_codinh',dt_didong='$dt_didong',fax='$fax',kichhoat='$kichhoat',ngay='$ngay',ip='$ip'";
		...
		if($result = mysql_query($query))
		{
		    ...
		    echo '<meta http-equiv="refresh" content="2;url=index.php?cat=0&start=0">';
...
else
{
	...
	$result = select_co_dk("tb_member","ma_user",$ma_user,"id","ASC");
	$rs = mysql_fetch_array($result);
?>
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
  ...
  <tr class="bg_mo">
    ...
    <tr class="bg_mo">
      <td height="20" align="right" valign="middle" class="text_def" >Mark:</td>
      <td height="20" valign="middle" class="text2" ><input name="diem" type="text" class="bottom" id="fullname2" style="WIDTH:150px;"  value="<?=$rs["diem"]?>" /></td>
    </tr>
    <tr class="bg_mo">
  ...
  <tr class="bg_mo">
    ...
    <td valign="middle" class="text2" ><input name="Submit" type="submit" class="bottom" value="Update"></td>
  </tr>
  </form>
</table>
<?php }?></td>
