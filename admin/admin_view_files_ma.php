					 ...
					 ?>
								...
								<table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
									...
									<tr bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';>
									  ...
									  <td><a href="admin_view_files.php?cat=<?=$rs["ma_files"]; ?>&start=0"><? echo"<img src=\"images/folder.gif\" border=\"0\" align=\"absmiddle\"/> "; ?><?=$rs["ten_ma_files"] ?></a></td>
									  <td><?=$rs["mo_ta"] ?></td>
									  <td><? 
									  		 if($suid==1)
											 $num_ = dem_max_dk("tb_files","ma_files",$ma_files);
											 else
											 $num_ = dem_max_2dk("tb_files","ma_files",$ma_files,"user",$ma_user_admin);
										     echo"$num_";
									      ?></td>
									  ...
									  <td colspan="2" align="center"><? if($num_==0) {?><a href="admin_view_files_ma_edit.php?id=<?=$rs["id"]?>&ma_edit=ma_files"><img src="images/edit.gif" alt="Edit" border="0"></a><? }?></td>
									  </tr>
									<? } ?>
									</table>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/bg_icon.gif">
										  <tr>
											...
											<img src="images/delete.gif" onClick="delete_all_do('admin_delete_wait.php','?ma_del=ma_files')" style="cursor: pointer" alt="<?=$view_item_buttom_xoa?>" align="absmiddle"/>
											</td>
										  </tr>
										</table>
