...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				function Check(form)
				{
				  if(form.tendichvu.value == 0)
				  {
					alert("Please select enter 'Name Folder'!");
					form.tendichvu.focus();
					return (false);
				  } 
				 }
				</SCRIPT>
            ...
            <table id="datatable" class="tbldata" cellpadding=10 width="420" cellspacing=0 border=0>
							<form name="form" method="post" action="admin_add.php?ma_add=ma_flash" onSubmit="return Check(this)">							<thead>
							  <tr>
