				...
				<? 
					...
					$ma_add=$HTTP_GET_VARS["ma_add"];
						...
						if( $ma_add=="add_files_download")
							...
							$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_$lg,ghi_chu_$lg,mo_ta_$lg,key_word_$lg,thu_tu,anh_nho,anh,activate_,activate,banner,nguoi_viet,gio,ngay)";
						...
						if( $ma_add=="add_one_page")
							...
							switch($lg){
								case "vn":
									$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_vn,mo_ta_vn,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
									break;
								case "eg":
									$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_eg,mo_ta_eg,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
									break;
								case "kr":
									$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_kr,mo_ta_kr,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
									break;
								default:
									$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_vn,mo_ta_vn,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
									break;									
						...
						if( $ma_add=="add_lich_chieu")
							{
							
							$ngay_chieu = $HTTP_POST_VARS["ngay_chieu"];
							$ngay_chieu=chuan_php($ngay_chieu);
							...
							$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ngay_chieu,mo_ta_vn,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
							$sql .=" values('";			
							$sql .=rep($cat)."','";
							$sql .=rep($cat_s)."','";
							$sql .=rep($cat_s_s)."','";
					...
					if( $ma_add=="add_weblink")
							...
							$sql="insert into tb_news(ma_bac_1,ma_bac_2,ma_bac_3,ma_bac_4,ma_bac_5,ten_$lg,ghi_chu_$lg,thu_tu,activate_,activate,banner,nguoi_viet,gio,ngay)";
						...
						if( $ma_add=="add_product_2_images")
							...
							if($gio_n=="") $gio=$gio_df; else $gio=$gio_n;
									...
									product_status,
									product_mark,
									product_nguyen_hop_$lg,
									product_bao_hanh_$lg,
									product_visitors,
									product_khuyen_mai_$lg,
									product_price_note_$lg,
									product_tien_nghi_$lg,
									product_ho_tro_$lg,
									product_thang_gia,
									product_nam_san_xuat,
									product_catalog,
									product_cho_ngoi,
									mo_ta_$lg,thu_tu,anh_nho,anh,activate_,activate,banner,nguoi_viet,gio,ngay)";
							...
							$sql .=$product_status."','";
							$sql .=$product_mark."','";
							$sql .=$product_nguyen_hop."','";
							$sql .=$product_bao_hanh."','";
							$sql .=$product_visitors."','";
							$sql .=$product_khuyen_mai."','";
							$sql .=$product_price_note."','";
							$sql .=$product_tien_nghi."','";
							$sql .=$product_ho_tro."','";
							$sql .=$product_thang_gia."','";
							$sql .=$product_nam_san_xuat."','";
							$sql .=$product_catalog."','";
							$sql .=$product_cho_ngoi."','";
							$sql .=$noidung."','";
							$sql .=rep($HTTP_POST_VARS{"thu_tu"})."','";	
							$sql .=$anh_nho_rename."','";
							$sql .=$anh_rename."','";	
							...
							if($bac=="1")
							   {
								...
								$all_quyen_cr=$all_quyen_cr.",$ma_bac_1";
								
								
								$query_2 = "UPDATE tb_admin SET quyen_catalog ='$all_quyen_cr' ";
								$query_2 .= " WHERE ma_user= $ma_user_admin";
							...
							if($bac=="2")
							   {
								...
								$all_quyen_cr_s=$all_quyen_cr_s.",$ma_bac_2";
								
								$query_2 = "UPDATE tb_admin SET quyen_catalog_s ='$all_quyen_cr_s' ";
								$query_2 .= " WHERE ma_user= $ma_user_admin";
								$result_2 = mysql_query($query_2);
							   }
						}
				...
				if( $ma_add=="style")
							{
								$ma_images=$HTTP_POST_VARS{"ma_images"};
								  ...
								  $name_folder=gia_tri_mot_cot("tb_style_site_ma","ma_files",$ma_images,"ten_ma_files");
								  $path_upload="styles";
								  $files_ref="admin_view_style.php";
								...
								if (!in_array($filetype_1,$imgarray))
								   {
									echo"Invalid filetype. Please use only a .JPG, .GIF, .PNG, .DOC, .XLS file. , .ZIP, .RAR. CSS";
								   }
								 else
									{
									$file_name_1=$name_folder."/".$anh_1;
									
									$key_1=dem_max_dk("tb_style_site","ten_file","$file_name_1");
									...
									if($key_1==0)
									{
									 ...
									 $thu_tu = max_cot("tb_style_site","thu_tu")+1; 
									 $sql="insert into tb_style_site(ten_files,ten_files_,ghi_chu,ma_files,user,thu_tu,ngay)";
									 ...
									 echo"<br><br> Can not upload file ! You rename '$anh_1' & uploat again !";
								  }
							      }
								...
								if (!in_array($filetype_2,$imgarray))
								   {
									...
									$key_2=dem_max_dk("tb_style_site","ten_file","$file_name_2");
									...
									if($key_2==0)
									{
									 ...
									 echo"<br><br> Can not upload file ! You rename '$anh_2' & uploat again !";
								  }
							   	  }
								...
								if (!in_array($filetype_3,$imgarray))
								   {
									...
									$key_3=dem_max_dk("tb_style_site","ten_file","$file_name_3");
									...
									if($key_3==0)
									{
									 ...
									 echo"<br><br> Can not upload file ! You rename '$anh_3' & uploat again !";
								  }
							   }
								$anh_4="";
								$anh_4=$HTTP_POST_FILES['userfile_4']['name']; 
								...
								if (!in_array($filetype_4,$imgarray))
								   {
									...
									$key_4=dem_max_dk("tb_style_site","ten_file","$file_name_4");
									...
									if($key_4==0)
									{
									 ...
									 echo"<br><br> Can not upload file ! You rename '$anh_4' & uploat again !";
								  }
							   }
								...
								if (!in_array($filetype_5,$imgarray))
								   {
									...
									$key_5=dem_max_dk("tb_style_site","ten_file","$file_name_5");
									...
									if($key_5==0)
									{
									 ...
									 echo"<br><br> Can not upload file ! You rename '$anh_5' & uploat again !";
								  }
							   }							   							   							
							echo"<br><br>[ <a href=\"#\" onClick=\"history.go(-1);\"><b>Back</b></li></a> | <a href=\"$files_ref?cat=$ma_images&start=0\"><b>View</b></a> ]";
							}
...
if($HTTP_GET_VARS["ma_add"]=="ma_style")
					...
					||($HTTP_GET_VARS["ma_add"]=="add_one_page")
					||($HTTP_GET_VARS["ma_add"]=="add_lich_chieu")
