...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
	...
	<td align="left" valign="middle" class="line_bottom"><?=$anh?></td>
	      ...
	      <tr align="center" valign="middle" bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';> 
	  <td width="20%" height="19" align="right" valign="middle" class="line_bottom"><span class="tab_lr_5"><?=$view_item_images_large?></span></td>
	...
	<tr align="center" valign="middle" bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';> 
	  <td width="20%" height="20" align="right" valign="middle" class="line_bottom"><span class="tab_lr_5"><?=$view_item_content_3?></span></td>
	<td align="left" valign="top" class="line_bottom"><? 
		
		 if(strstr($noidung_1,"upload_file"))
		   $noidung_1=$noidung_1;
		 else
		   $noidung_1=str_replace("data/","../../data/",$noidung_1);
	...
	<tr align="center" valign="middle" bgcolor='ffffff' onMouseOut=this.style.backgroundColor='#ffffff'; onmouseover=this.style.backgroundColor='#EAEAEA';> 
	  <td width="20%" height="20" align="right" valign="middle" class="line_bottom"><span class="tab_lr_5"><?=$view_item_content_4?></span></td>
	<td align="left" valign="top" class="line_bottom"><? 
		
		 if(strstr($noidung_2,"upload_file"))
		   $noidung_2=$noidung_2;
		 else
		   $noidung_2=str_replace("data/","../../data/",$noidung_2);
