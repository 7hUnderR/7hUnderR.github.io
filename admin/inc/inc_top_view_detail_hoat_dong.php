...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					if($suid==1){						
						switch($bac){
							case "1";
								$query = "Select * FROM  $tb_setup where ma_bac_1=$cat and banner!=1 $sort ";
								break;
							case "2";
							...
							case "3";
								...
								break;
							case "4";
								$query = "Select * FROM  $tb_setup where ma_bac_3=$cat and ma_bac_4=0 $sort ";
								break;
							case "5";
					...
					else
					{
						switch($bac){
							case "1";
								$query = "Select * FROM  $tb_setup where ma_bac_1=$cat and nguoi_viet=$ma_user_admin and banner!=1 $sort ";
								break;
							case "2";
							...
							case "3";
								...
								break;
							case "4";
								$query = "Select * FROM  $tb_setup where ma_bac_3=$cat and ma_bac_4=0 and nguoi_viet=$ma_user_admin $sort ";
								break;
							case "5";
					...
					if($suid==1){
						switch($bac){
							case "1";
								$query = "Select * FROM  $tb_setup where ma_bac_1=$cat and banner!=1 $sort ORDER BY thu_tu DESC LIMIT $start, $page_count ";
								break;
							case "2";
						...
						switch($bac){
							case "1";
								$query = "Select * FROM  $tb_setup where ma_bac_1=$cat and banner!=1 and nguoi_viet=$ma_user_admin and nguoi_viet=$ma_user_admin $sort ORDER BY thu_tu DESC LIMIT $start, $page_count ";
								break;
							case "2";
							...
							case "5";
								...
								break;
							default:
								$query = "Select * FROM  $tb_setup where ma_bac_1=$cat and banner!=1 and nguoi_viet=$ma_user_admin $sort ORDER BY thu_tu DESC LIMIT $start, $page_count ";							
								break;
						}					
					}
					$result = mysql_query($query);
