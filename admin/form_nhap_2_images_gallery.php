...
<table id="datatable" class="tbldata" cellpadding=5 width="600" cellspacing=0 border=0>
 ...
 function thumbnail_check() 
 {
	...
	<form method="post" action="admin_add.php?ma_add=add_news_2_images_gallery" ENCTYPE="multipart/form-data" name="noi_dung" onSubmit="return Check_Values_nhap(this);">
