...
<table id="datatable" class="tbldata" cellpadding=5 width="600" cellspacing=0 border=0>
 ...
 function thumbnail_check() 
 {
	...
	<form method="post" action="admin_edit_save.php?save=edit_news_2_images&id=<?=$HTTP_GET_VARS["id"]?>&lg=<?=$lg?>&start=<?=$HTTP_GET_VARS["start"]?>" ENCTYPE="multipart/form-data" name="noi_dung" onSubmit="return Check_Values_nhap(this);">
