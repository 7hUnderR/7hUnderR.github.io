        ...
        <!--DWLayoutTable-->
              ...
              <tr>
                <td valign="top" class="bg_center">
					...
					$i=0;
					$tam=0;
					$path_sub=path_upload_mannager("files");
					?>
					<form name=messageList ENCTYPE="multipart/form-data" method=post action="admin_edit_save.php?save=sort_files">
					  ...
					  <table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
									...
									<thead>
									  ...
									  <th width="37%" id="senderheader"><?=$upload_select_folder?></th>
									  ...
									  <th width="15%" id="senderheader"><?=$item_note?></th>
									...
									<? } ?>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/bg_icon.gif">
										  <tr>
											...
											<img src="images/delete.gif" onClick="delete_all_do('admin_delete_wait.php','?ma_del=files')" style="cursor: pointer" alt="<?=$view_item_buttom_xoa?>" align="absmiddle"/>
											</td>
										  </tr>
										</table>									    
