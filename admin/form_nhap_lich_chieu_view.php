...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
				    ...
				    <script language="JavaScript" type="text/JavaScript">
						...
						<SCRIPT language=JavaScript>
							...
							function view_content(id, lg){
								...
								window.open ("inc/popup_content_lich_chieu.php?ma=product&id="+ id + "&lg=" + lg,"a",arg);	
	        ...
	        <form name=messageList ENCTYPE="multipart/form-data" method=post action="admin_edit_save.php?save=sort_items_news_lich_chieu">
			<table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
				...
				<th id="subjectheader" width=20%><? echo"$view_item_detail"?></th>
				...
				<td><? echo"<a href=javascript:view_content('$id','$lg')><img src=\"images/file.gif\" border=\"0\" align=\"absmiddle\"/></a>";?><input name="ngay_chieu_<?=$i?>" type="text" class="input" style=" width: 150px;" value="<?=$rs["ngay_chieu"]?>" ></td>
				<td class="lot"><? 
				  if($rs["anh_nho"]!="") 
