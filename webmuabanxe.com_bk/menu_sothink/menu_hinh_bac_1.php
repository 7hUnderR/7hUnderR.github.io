...
<script language="javascript">
			...
			$i=0;
			$i_bg=0;
			$query = "Select * FROM  tb_bac_1 where trang in ('2','3','4','32','17') and activate=1 and activate_setup=1 order by thu_tu ASC ";
		  ...
		  /*switch($i_bg)
			...
			//[1,2,Vi tri menu sub,0,1,Cach tren cah duoi,0,0,100
			stm_bpx("p1","p0",[1,4,0,0,1,3,0,0,100,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=forward,enabled=0,Duration=0.70)",5,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=reverse,enabled=0,Duration=0.70)",4,50,0,0,"#FFFFFF","#ffffff"]);
			<?
			$j=0;
			...
			?>
				...
				stm_bpx("p3","p1",[1,2,0,0,1,3,0,0,100,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=forward,enabled=0,Duration=0.70)",5,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=reverse,enabled=0,Duration=0.70)",4,50,0,0,"#FFFFFF","#ffffff"]);
					<?
					$k=0;
