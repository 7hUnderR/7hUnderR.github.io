...
<script language="javascript">
			...
			stm_bp("p0",[1,4,0,0,0,0,0,0,100,"",-2,"",-2,50,0,0,"#ffffff","transparent","",3,0,0,"#FFFFFF"]);
			<?
			$i=0;
			$i_bg=0;
			$query = "Select * FROM  tb_bac_1 where trang in ('1','2','3','30','17','6') and activate=1 and activate_setup=1 order by thu_tu ASC ";
		  ...
		  /*switch($i_bg)
			...
			stm_bpx("p1","p0",[1,2,0,0,0,2,0,0,100,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=forward,enabled=0,Duration=0.70)",5,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=reverse,enabled=0,Duration=0.70)",4,50,0,0,"#FFFFFF","#ffffff"]);
			<?
			$j=0;
			...
			?>
				stm_aix("p2i<?=$j?>","p0i0",[0," <?=$ten_tp?>  ","","",-1,-1,0,"<?=$link?>","_self","","","","",0,0,0,"","",0,0,0,0,1,"<?=$mau_bg?>",0,"<?=$mau_bg_over?>",0,"","",3,3,0,0,"#e3b73d","#e3b73d","#000000","#000000","11px tahoma","11px tahoma",0,0]);
				stm_bpx("p3","p1",[1,2,0,0,1,1,0,0,100,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=forward,enabled=0,Duration=0.70)",5,"progid:DXImageTransform.Microsoft.Wipe(GradientSize=1.0,wipeStyle=1,motion=reverse,enabled=0,Duration=0.70)",4,50,0,0,"#FFFFFF","#ffffff"]);
					<?
					$k=0;
			...
			if($i< $num_menu)
			{?>
			stm_aix("p0i1","p0i0",[2,"","images/layout/phamnguyen_layout_11.gif","images/layout/phamnguyen_layout_11.gif",137,12,0,"","_self","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff",1,"#ffffff",1,"","",3,3,0,0,"#ffffff","#000000","#000000","#000000","8pt Verdana","8pt Verdana"]);
			<?  } } ?>
			stm_em();
			        </script>