...
<script src="lightbox/lightbox_plus.js" type="text/javascript"></script>
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			while($rs= mysql_fetch_array($result2))
			 { 
			  ...
			  $ten = $rs["ten_$lg"];
			  if($rs["anh_nho"]!="") 
			  $anh="<a rel=\"lightbox\" href=\"images/photo/news/$rs[anh]\" ><img src=\"images/photo/news/$rs[anh_nho]\" border=1 vspace=5 class=border_images alt=\"$ten\"></a>";
			  else
			  $anh="";
			  $ten="<a rel=\"lightbox\" href=\"images/photo/news/$rs[anh]\" >".$rs["ten_$lg"]."</a>";
