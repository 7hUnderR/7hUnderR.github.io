	<table class="block_2_top" cellspacing=0 cellpadding=0 width="325" border=0>
		  <tr>
			<td valign="middle" class="tab_8_8 block_2_title"><?=gia_tri_mot_cot("tb_bac_2","trang",9,"mo_ta_$lg");?></td>
		  </tr>
		  <tr>
			<td valign="top" class="block_2_center" height="220">
				<? 
	$ma_sub_newscn = gia_tri_mot_cot("tb_bac_2","trang",9,"ma_bac_2");
	$table="tb_news";
	$query_cn = "Select * FROM  $table where ma_bac_2=$ma_sub_newscn and banner!=1 and activate=1 and ngoai_index = 1 ORDER BY thu_tu DESC LIMIT 0, 10";
