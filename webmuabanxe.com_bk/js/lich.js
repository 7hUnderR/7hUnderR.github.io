      ...
      for (var i = 1; i < 8; i++) {
         if ((Loop_Counter >= First_Day) && (Day_Counter <= Days_in_Month[Month])) {
            if ((Day_Counter == Today) && (Year == Current_Year) && (Month == Current_Month)) {
               HTML_String += '<td BGCOLOR="CCCCCC" align="center" ><strong><font color="red">' + Day_Counter + '</font></strong></td>';
            }
            else {
               HTML_String += '<td align="center" ><a href="lich.html?'+Day_Counter+'/'+Month+'/'+Year+'">' + Day_Counter + '</a></td>';
            }
            Day_Counter++;    
         }
         else {
