...
<input type="hidden" name="login_form_" value="login_form_">
  <table width="400"  border="0" align="center" cellpadding="1" cellspacing="1" class="tbldata">
	...
	<th align="left" valign="middle" id="senderheader"><?=gia_tri_mot_cot("tb_bac_2","trang",76,"ten_$lg")?></th>
	</tr>
	</thead>
    <tr>
      <td height="24" align="right" class="text_tb">Địa chỉ email:</td>
      <td width="253" class="text_tb"><input name="email" type="text" class="textfield" id="email" style="width:200px;" value="">
       *</td>
    </tr>
    <tr>
      <td height="24" align="right" class="text_tb">Mật khẩu:</td>
      <td class="text_tb"><input name="password" type="password" class="textfield" id="password" style="width:120px;" maxlength="16">
        * <a href="./?Bcat=<?=gia_tri_mot_cot("tb_bac_2","trang",68,"ma_bac_2");?>&amp;lg=<?=$lg?>&amp;start=0"><strong><?=gia_tri_mot_cot("tb_bac_2","trang",68,"ten_$lg");?></strong></a> </td>
    </tr>
    <tr class="text_tb">
      <td height="26" class="text2"><!--DWLayoutEmptyCell-->&nbsp;</td>
      <td valign="middle"><span class="text2">
        <input name="Submit" type="submit" class="nut_nhan_2" value="<?=gia_tri_mot_cot("tb_bac_2","trang",76,"ten_$lg");?>" style="width:70px;" />
      </span></td>
    </tr>
  </table>
</form>
