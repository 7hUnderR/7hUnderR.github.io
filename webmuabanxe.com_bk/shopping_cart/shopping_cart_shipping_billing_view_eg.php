...
<div id="email_content">
  ...
  <tr valign="middle" class="text_def"> 
    <td height="22" colspan="2" class="border_b tieu_de" ><strong>Address Information</strong></td>
    </tr>
	    <tr valign="center" class="bg_all"> 
    <td width="50%" height="18" align="left" valign="middle" class="text_def"><strong>Shipping Address</strong></td>
    <td align="left" valign="middle" class="main_bold"><strong>Billing Address</strong></td>
    </tr>
    ...
    <td height="50"  align="left" valign="top" class="text_def"><?
		echo"$name";
		echo"<br>Address: $address_1";
		echo"<br>Email: $email_1";
		echo"<br>Country: $country_text";
		echo"<br>Phone: $phone_1";
		echo"<br>Mobile: $phone_2";
	?></td>
    <td  align="left" valign="top" class="style3"><?
		echo"$b_name";
		echo"<br>Address: $b_address_1";
		echo"<br>Email: $b_email_1";
		echo"<br>Country: $b_country_text";
		echo"<br>Phone: $b_phone_1";
		echo"<br>Mobile: $b_phone_2";
	?></td>
    </tr>
    <tr valign="top" class="text_def"> 
    <td height="19" colspan="2" align="middle"> 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="text_def">
      <!--DWLayoutTable-->
    <tr valign="middle"> 
    <td height="22" colspan="7" class="tieu_de" ><strong>Order Contents</strong></td>
    </tr>
	    <tr valign="center" class="bg_all"> 
    <td width="5%"  height="19" align="center" valign="middle" >No.</td>
    <td colspan="2" align="left" valign="middle" >Name</td>
    <td width="20%" >Code</td>
    <td width="20%" align="left" valign="middle" >Price</td>
    <td width="10%"  align="left" valign="middle" >Quantity </td>
    <td width="20%"  align="left" valign="middle" >Sum Price</td>
    </tr>
    <tr valign="top"> 
    <td height="19" colspan="7" align="middle"> 
    ...
    <?=$i?>    </td>
    <td colspan="2" align="left" valign="middle" class="ten_product"><a href="./?id_pproductv=<?=$id?>&lg=<?=$lg?>&start=0"><?=$ten?>
    </a></td>
    <td><?=$code?></td>
	...
	echo $price_sum_item_v." $project_tien"; ?></td>
	    ...
	    <tr> 
    <td height="22">&nbsp;</td>
    <td width="225"  valign="middle" ><span class="ten_product">
      <input type=hidden value="<?=$size?>" name="size_<?=$id?>"> 
    </span></td>
    <td width="126" align="left" valign="middle" class="ten_product"><input type=hidden value="<?=$color?>" name="color_<?=$id?>"></td>
    <td>&nbsp;</td>
    ...
    <?
	 ...
	 ?>
    <tr valign="top"> 
    <td height="10" colspan="7" align="middle"><hr size="1" noshade color="#999999"></td>
    </tr>
    <tr align="right" valign="middle">
      <td height="21" colspan="4" align="left" valign="middle"><!--DWLayoutEmptyCell-->&nbsp;</td>
    ...
    <tr align="right" valign="middle">
	  ...
	  $sum_price = $sum_price - $sum_discount;
	  echo $discount_value*100; 
	  $sum_discount_v=number_format($sum_discount);
	  echo "% = $sum_discount_v $project_tien";
	  ?></td>
      </tr>
    <tr align="right" valign="middle">
      <td height="21" colspan="4" align="left" valign="middle"><!--DWLayoutEmptyCell-->&nbsp;</td>
      <td align="left" valign="middle"><? echo "Shipping:"; $tax_value=gia_tri_mot_cot("tb_shopping_cart_tax","tax_code","$tax","tax_value")?></td>
      <td colspan="2" align="left" valign="middle"><? 
	  $tax_value_v=number_format($tax_value);
	  echo "$tax_value $project_tien"; ?></td>
      </tr>
    <tr align="right" valign="middle"> 
    <td height="21" colspan="4" align="left" valign="middle">Notes:</td>
    <td rowspan="2" align="left" valign="middle"><? echo"<b>Total: &nbsp;</b>";?></td>
      <td colspan="2" rowspan="2" align="left" valign="middle"><b>
        <? $total=$tax_value+$sum_price; 
	  $total=number_format($total);
	  echo $total." $project_tien"; ?>
      </b></td>
      </tr>
    <tr align="right" valign="middle">
      <td colspan="4" rowspan="2" align="left" valign="top"><div contenteditable="true" 
	...
	<tr align="left" valign="top" class="bg_all">
	  <td height="19" colspan=7 valign="middle" class="tab_left_10"> 
