...
<link href="shopping_cart/style.css" rel="stylesheet" type="text/css" />
    ...
    <tr>
      <td>&nbsp;</td>
      <td align="left" valign="top" class="text_register">
        <input type="submit" name="Submit22" value="<?=gia_tri_mot_cot("tb_bac_2","trang",74,"ten_$lg");?>" align="absmiddle" class="nut_nhan"/></td>
    </tr>
	<tr>
	  <td colspan="2"></td>
	</tr>
