		...
		{						
			if($row[4]==1)
			{
				...
				*/
				...
				echo"<meta http-equiv=\"refresh\" content=\"0;url=./?lg=$lg\">";
			}
			else
			{
				$suid=-3;
  ...
  <table width="400"  border="0" align="center" cellpadding="1" cellspacing="1" class="tbldata">
    ...
    <tr>
      ...
      <td class="text_tb"><input name="password" type="password" class="textfield" id="password" style="width:120px;" maxlength="16">
        * <a href="../?Bcat=<?=gia_tri_mot_cot("tb_bac_2","trang",81,"ma_bac_2");?>&amp;lg=<?=$lg?>&amp;start=0"><strong><?=gia_tri_mot_cot("tb_bac_2","trang",81,"ten_$lg");?></strong></a> </td>
    </tr>
    <tr class="text_tb">
