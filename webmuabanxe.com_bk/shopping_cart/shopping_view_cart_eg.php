...
<table width="100%" border="0" cellpadding="1" cellspacing="1" class="tbldata">
   ...
   <form action="<?=$form_action?>" method="post" name="frmList" onSubmit="return checkInput();">
    ...
    <td width="63" height="18" align="center" valign="middle" class="text_tb">No.</td>
    ...
    <td width="129" class="text_tb"><span class="tab_left_3">Code</span></td>
    <td width="383" align="left" valign="middle" class="text_tb"><span class="tab_left_3">Name</span></td>
    <td width="81" align="left" valign="middle" class="text_tb"><span class="tab_left_3">Price</span></td>
    <td width="66" align="left" valign="middle" class="text_tb"><span class="tab_left_3">Quantity</span></td>
    <td width="146" align="left" valign="middle" class="text_tb"><span class="tab_left_3">Sum Price</span></td>
    </tr>
    <?php
	if($cart!=" ")
	{
    ...
    <td height="25" colspan="6" align="right" valign="middle" class="text_def"><? echo"Shipping: &nbsp;";?>
    ...
    <td align="left" valign="middle" class="text_def"><? echo"Total: &nbsp;";?></td>
    ...
    <td height="36" colspan=7 valign="middle" class="tab_left_3"> 
     <input type="button" class="nut_nhan_2"  value="Continue shopping" onClick="javascript: shopping('<?=gia_tri_mot_cot("tb_bac_2","trang",10,"ma_bac_2");?>','<?=$lg?>');" style="width:140px;">
	 <input type="button" class="nut_nhan_2" value="<?=gia_tri_mot_cot("tb_bac_2","trang",78,"ten_$lg");?>" onClick="javascript: update('<?=gia_tri_mot_cot("tb_bac_2","trang",79,"ma_bac_2");?>','<?=$lg?>','0');">
	...
	<tr bgcolor="#FFFFFF">
	  <td height="14" colspan="7" valign="top" class="tab_left_3"><em class="text_tb">Notice: After changing quantity or shipping method -  Remember to click &quot;Update Cart&quot;</em></td>
     </tr>
  <? 
  } 
  else
  ...
  ?>
    ...
    <td height="18" colspan=7 align="center" valign=center class="trang"><b class="text_tb">Opps! Your bag is empty.</b></td>
    </tr>
    <tr align="left" valign="top" bgcolor="#FFFFFF" class="bg_all"> 
    <td height="25" colspan=7 valign="middle" class="tab_left_3">
	  <input type="button" class="nut_nhan_2"  value="Continue shopping" onClick="javascript: shopping('<?=gia_tri_mot_cot("tb_bac_2","trang",10,"ma_bac_2");?>','<?=$lg?>');" style="width:140px;">	</td>
    </tr>
    <?php
}
