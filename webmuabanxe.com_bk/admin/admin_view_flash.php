        ...
        <!--DWLayoutTable-->
              ...
              <tr>
                <td valign="top" class="bg_center">
					...
					$i=0;
					$tam=0;
					$path_sub=path_upload_mannager("flash");
					?>
					<form name=messageList ENCTYPE="multipart/form-data" method=post action="admin_edit_save.php?save=sort_flash">
									...
									<? } ?>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/bg_icon.gif">
										  <tr>
											...
											<img src="images/delete.gif" onClick="delete_all_do('admin_delete_wait.php','?ma_del=flash')" style="cursor: pointer" alt="<?=$view_item_buttom_xoa?>" align="absmiddle"/>
											</td>
										  </tr>
										</table>									    
