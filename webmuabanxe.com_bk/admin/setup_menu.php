...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr class="M">
                <td height="25" valign="middle" class="bg_title"><img src="images/home.gif" width="14" height="14" border="0"> Setup menu</td>
             </tr>
              <tr>
		...
		if(strstr($_SERVER["QUERY_STRING"],"add"))
		 {
			...
			$table_="tb_setup_menu";
			$query_ = "INSERT INTO $table_(menu_ma,menu_ten,menu_link,menu_target,menu_quyen,menu_type,menu_sort,menu_activate)";
			$query_ .= " VALUES('$menu_ma','$menu_ten','$menu_link','$menu_target','$menu_quyen','$menu_type','$menu_sort','$menu_activate')";
			if($result_ = mysql_query($query_))
			$tip="Add completed !";
				
			echo"<meta http-equiv=\"refresh\" content=\"0;url=setup_menu.php\">";
		...
		if(strstr($_SERVER["QUERY_STRING"],"delete"))
		 {
			...
			$query__ = "DELETE  FROM tb_setup_menu WHERE id in ('$items')";
		...
		if(strstr($_SERVER["QUERY_STRING"],"update"))
		   {
			...
			$query_edit = "UPDATE tb_setup_menu SET menu_ten='$menu_ten',menu_link='$menu_link',menu_target='$menu_target',menu_quyen='$menu_quyen',menu_type='$menu_type',menu_sort='$menu_sort',menu_activate='$menu_activate'";
      ...
      <br>
	  <? 
		$table="tb_setup_menu order by menu_sort ASC ";
...
<table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
	...
	<td>
	 <?
	 echo "<a href=\"setup_menu_s.php?id=$id\">".$rs_edit["menu_ten"]."</a>";
	 ?>
	<br />
