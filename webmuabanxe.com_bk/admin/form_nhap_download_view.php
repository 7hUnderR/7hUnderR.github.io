...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="85%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
				    ...
				    <script language="JavaScript" type="text/JavaScript">
						...
						<SCRIPT language=JavaScript>
							...
							function view_content(id, lg){
								...
								window.open ("inc/popup_content_download.php?ma=product&id="+ id + "&lg=" + lg,"a",arg);	
			...
			<table id="datatable" class="tbldata" width="100%" cellpadding=2 cellspacing=0 border=0>
				...
				<th width=45% id="senderheader"><?=$view_item_tieude?></th>
				...
				<td class="lot"><? 
				  if($rs["anh_nho"]!="") 
				    echo"<span class=lot>| <a onclick=\"javascript: popupImage('../images/photo/$rs[anh_nho]')\" href=\"#\"><b>?</b></a></span>";
				  ?><? 
				  if($rs["anh"]!="") 
				    {
					echo"<span class=lot> | <a href=\"../images/photo/news/$rs[anh]\"><b>?</b></a></span>";
					}
