          ...
          <tr>
            <td align="center" valign="middle"><? 
				...
				$rs= mysql_fetch_array($result);
				  ...
				  $cho_ngoi=$rs["product_cho_ngoi"];
				  $nam_san_xuat=$rs["product_nam_san_xuat"];
				  $dong_xe=$rs["product_catalog"];
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="middle" class="block_4_title border_b"><img src="images/icon/icon_p.gif" align="absmiddle" /><strong>Chỗ ngồi :</strong></td>
              <td height="25" valign="middle" class="border_b"><?=gia_tri_mot_cot("tb_product_type_2","code",$cho_ngoi,"name_$lg");?></td>
            </tr>
            <tr>
              <td valign="middle" class="block_4_title border_b"><img src="images/icon/icon_p.gif" align="absmiddle" /><strong>Dòng xe:</strong></td>
              <td height="25" valign="middle" class="border_b"><?=gia_tri_mot_cot("tb_product_type_5","code",$dong_xe,"name_$lg");?></td>
            </tr>
            <tr>
              <td valign="middle" class="block_4_title border_b"><img src="images/icon/icon_p.gif" align="absmiddle" /><strong>Năm sản xuất:</strong></td>
              <td height="25" valign="middle" class="border_b"><?=gia_tri_mot_cot("tb_product_type_4","code",$nam_san_xuat,"name_$lg");?></td>
            </tr>
            <tr>
            ...
            <? if($ghi_chu!=""){?>
			<tr>
              <td height="30" colspan="2" align="left" valign="middle" class="border_b"><?=$ghi_chu;?></td>
            </tr>
			<? }?>
          </table>
		<?
