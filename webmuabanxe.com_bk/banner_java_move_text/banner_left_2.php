...
<?
	...
	while($rs= mysql_fetch_array($result))
	{
	  ...
	  ?>
		<DIV class=ja-catslwi style="BACKGROUND: url(<?=$banner?>) no-repeat; CURSOR: pointer; HEIGHT: 200px" 
		onclick="location.href='<?=$link_banner;?>'">
		<DIV class=ja-catslwi-container>
		<DIV class=ja-catslwi-text>
		<DIV class=ja-catslwi-content id=ja-catslwi-textbg_2<?=$i?> style="HEIGHT: 120px; ">
		<SCRIPT type=text/javascript>
					textbg = document.getElementById("ja-catslwi-textbg_2<?=$i?>");
